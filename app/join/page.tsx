...
export default function JoinPage() {
  ...
  const peerRef = useRef<Peer | null>(null); // To manage the Peer instance lifecycle
  ...
  const joinRoom = () => {
    ...
    peerRef.current = peer; // Store the Peer instance for cleanup
              ...
              <div className="space-y-4">
                ...
                >
                  <video
                    ...
                    playsInline
                    controls={false}
                    aria-label="Remote Screen Sharing"
                  />
                  <Button
                    variant="secondary"
                    size="icon"
